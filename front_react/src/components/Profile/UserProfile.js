...
export default function Profile() {
  ...
  useEffect(() => {
    // Fetch user data
    axios
      .post("http://localhost/task_react/back_end/profile/viewProfile.php", {
    ...
    // Fetch order data
    axios
      .post("http://localhost/task_react/back_end/profile/orders.php", {
        id: localStorage.getItem("id"),
      })
      .then((response) => {
  ...
  const handleSaveChanges = () => {
    ...
    axios
      .post(
        "http://localhost/task_react/back_end/profile/update.php",
        updatedUser
      )
      .then((response) => {
